...
public class TimeHarvester {
	...
	public static void main(String[] args) throws Exception {
		...
		File outFile = new File(dFilePath + File.separator + "JFaCT_Times.csv");
		...
		File errorFile = new File(dFilePath + File.separator + "JFaCT_TimesError.csv");
		...
		try {
			...
			// We get a facade to access the JFact low level methods and
			// configuration
